		...
		<Grid.Column width={16}>
		    <Segment>
				<center>
					...
					<Button type='button' size='massive' positive onClick={()=>goTo(`/company/paysheet/management/latest/${company_id}`)}>Gestionar</Button>
				</center>
		    </Segment>
		</Grid.Column>
	    </Grid>);
		...
		<Grid>
				...
				<Grid.Column width={16}>
                    	<h3 style={{color:'black'}}>Generar nomina</h3>
						  ...
						  {JSON.stringify(props.StatisticsParams)}
						<Divider />
				</Grid.Column>
			...
			<Grid.Column width={6} style={{marginTop:'1em'}}>
                ...
                <Input
                    ...
                    placeholder='0.00'
                    name='tasa'
                    value={props.StatisticsParams.tasa}
                ...
                />
					...
					<Grid.Column width={16}>
						<Divider/>
                        <Button type='submit' positive>Calcular nomina</Button> 
            		</Grid.Column>
