...
function Layout(props) {
            ...
            <Grid.Row style={{height: '80vh'}}>
                <Grid.Column>
                    <NoItems
                        ...
                        message='Agrega nuevas solicitudes para mostrar la informacion'
                        firstButtonText={'Crear solicitud'}
                        firstPage={'/company/setup/employees-requests/create/'+props.company_id}
                        />
                </Grid.Column>
            </Grid.Row>
        </Grid>
    ...
    <Grid.Row>
        <Grid.Column>
            <GuiHeader
                header_text={'Configuracion de solicitudes de empleados'}
                button_text={'Nueva solicitud'}
                header_sub_text={'Loren ipsun dolor site amet'}
                page={'/company/setup/employees-requests/create/'+props.company_id}
            />
        </Grid.Column>
    </Grid.Row>
    <Grid.Row>
                    ...
                    return (<Table.Row key={key}>
                        ...
                        <Table.Cell>
                            ...
                            onClick={()=>handleItemClick(
                                '/company/setup/employees-requests/update/'+props.match.params.company_id+'/'+item.id
                                )}>
